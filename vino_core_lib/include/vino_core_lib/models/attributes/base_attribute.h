...
#ifndef VINO_CORE_LIB__MODELS__ATTRIBUTES__BASE_ATTRIBUTE_H
#define VINO_CORE_LIB__MODELS__ATTRIBUTES__BASE_ATTRIBUTE_H
...
#endif  // VINO_CORE_LIB__MODELS__ATTRIBUTES__BASE_ATTRIBUTE_H
