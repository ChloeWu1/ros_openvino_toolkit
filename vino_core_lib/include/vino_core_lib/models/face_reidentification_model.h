 ...
 */
#ifndef VINO_CORE_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_H
#define VINO_CORE_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_H
#include <string>
...
#endif  // VINO_CORE_LIB__MODELS__FACE_REIDENTIFICATION_MODEL_H
