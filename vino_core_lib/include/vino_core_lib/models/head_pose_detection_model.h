...
#ifndef VINO_CORE_LIB__MODELS__HEAD_POSE_DETECTION_MODEL_H
#define VINO_CORE_LIB__MODELS__HEAD_POSE_DETECTION_MODEL_H
...
#endif  // VINO_CORE_LIB__MODELS__HEAD_POSE_DETECTION_MODEL_H
