 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__EMOTIONS_DETECTION_H
#define VINO_CORE_LIB__INFERENCES__EMOTIONS_DETECTION_H
...
#endif  // VINO_CORE_LIB__INFERENCES__EMOTIONS_DETECTION_H
