 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__FACE_REIDENTIFICATION_H
#define VINO_CORE_LIB__INFERENCES__FACE_REIDENTIFICATION_H
#include <memory>
#include <vector>
#include <string>
...
#endif  // VINO_CORE_LIB__INFERENCES__FACE_REIDENTIFICATION_H
