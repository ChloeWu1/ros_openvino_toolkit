 ...
 */
#ifndef VINO_CORE_LIB__INFERENCES__PERSON_ATTRIBS_DETECTION_H
#define VINO_CORE_LIB__INFERENCES__PERSON_ATTRIBS_DETECTION_H
#include <memory>
#include <vector>
#include <string>
...
#endif  // VINO_CORE_LIB__INFERENCES__PERSON_ATTRIBS_DETECTION_H
